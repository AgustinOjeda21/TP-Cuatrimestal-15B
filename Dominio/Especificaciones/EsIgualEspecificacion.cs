...
{
    public class EsIgualEspecificacion<T, Tprop> : Especificacion<T>
    {
        private readonly Expression<Func<T, Tprop>> Selector;
        private readonly Tprop Valor;
        public EsIgualEspecificacion(Expression<Func<T, Tprop>> Selector, Tprop Valor)
        {
        ...
        public override Expression<Func<T, bool>> ToExpression()
        {
            ...
            var body = Expression.Equal(left, Expression.Constant(Valor, left.Type));
