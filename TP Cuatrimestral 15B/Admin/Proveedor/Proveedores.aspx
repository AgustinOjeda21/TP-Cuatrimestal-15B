<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Async="true" Inherits="TP_Cuatrimestral_15B.Admin.WebForm7" %>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Proveedor" PostBackUrl="~/Admin/Proveedor/AgregarProveedor.aspx" CssClass="btn btn-default" />
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Proveedor" PostBackUrl="~/Admin/Proveedor/ModificarProveedor.aspx" CssClass="btn btn-default" />
        </div>
        <table class="table table-striped table-hover tabla-admin">
            ...
            <tbody>
                <asp:Repeater ID="rptProveedor" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("Mail") %></td>
                            <td><%# Eval("Estado") %></td>
                            <td><%# Eval("Direccion.IdDireccion") %></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            </tbody>
