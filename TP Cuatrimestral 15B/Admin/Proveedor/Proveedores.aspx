...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Proveedor" PostBackUrl="~/Admin/Proveedor/AgregarProveedor.aspx"/>
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Proveedor" PostBackUrl="~/Admin/Proveedor/ModificarProveedor.aspx"/>
        </div>
