<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductosCarrito.aspx.cs" Async="true" Inherits="TP_Cuatrimestral_15B.Admin.WebForm9" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
   <title>Admin - Productos Carrito</title>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        <h2>Gestión de Productos de un carrito</h2>
        <div class="acciones-top">
            <asp:TextBox ID="txtBuscar" runat="server" placeholder="Buscar categoría..." CssClass="form-control"></asp:TextBox>
            <asp:Button ID="btnModificar" runat="server" Text="Modificar" PostBackUrl="~/Admin/ProductoCarrito/ModificarProductoCarrito.aspx" CssClass="btn btn-default" />
        </div>
        <table class="table table-striped table-hover tabla-admin">
            ...
            <tbody>
                <asp:Repeater ID="rptProductoCarrito" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><%# Eval("Carrito.IdCarrito") %></td>
                            <td><%# Eval("Producto.IdProducto") %></td>
                            <td><%# Eval("Cantidad") %></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
