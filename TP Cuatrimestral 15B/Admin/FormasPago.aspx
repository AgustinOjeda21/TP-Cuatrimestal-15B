<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormasPago.aspx.cs" Inherits="TP_Cuatrimestral_15B.Admin.AdminFormasPago" %>
<!DOCTYPE html>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <table class="tabla-admin">
            ...
            <tbody id="tbodyFormasPago" runat="server">
                <tr>
