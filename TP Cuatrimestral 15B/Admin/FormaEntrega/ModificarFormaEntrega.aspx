<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarFormaEntrega.aspx.cs" Inherits="TP_Cuatrimestral_15B.Admin.FormaEntrega.ModificarFormaEntrega" %>
    ...
    <div class="formulario">
        ...
        <div>
            <asp:Button
                ...
                runat="server"
                Text="Cancelar"
                PostBackUrl="~/Admin/FormaEntrega/FormasEntrega.aspx" CssClass="btn btn-default" />
        </div>
