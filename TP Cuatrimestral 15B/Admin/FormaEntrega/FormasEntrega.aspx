...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar forma de entrega" PostBackUrl="~/Admin/FormaEntrega/AgregarFormaEntrega.aspx" CssClass="btn btn-default" />
            <asp:Button ID="btnModificar" runat="server" Text="Modificar forma de entrega" PostBackUrl="~/Admin/FormaEntrega/ModificarFormaEntrega.aspx" CssClass="btn btn-default" />
        </div>
