...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Marca"  PostBackUrl="~/Admin/Marca/AgregarMarca.aspx"/>
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Marca"  PostBackUrl="~/Admin/Marca/ModificarMarca.aspx"/>
        </div>
