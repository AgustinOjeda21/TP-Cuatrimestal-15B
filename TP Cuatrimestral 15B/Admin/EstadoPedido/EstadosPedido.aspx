<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadosPedido.aspx.cs" Async="true" Inherits="TP_Cuatrimestral_15B.Admin.WebForm2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
   <title>Admin - Estados de pedido</title>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Estado Pedido" PostBackUrl="~/Admin/EstadoPedido/AgregarEstadoPedido.aspx" CssClass="btn btn-default" />
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Estado Pedido" PostBackUrl="~/Admin/EstadoPedido/ModificarEstadoPedido.aspx" CssClass="btn btn-default" />
        </div>
        <table class="table table-striped table-hover tabla-admin">
            ...
            <tbody>
                <asp:Repeater ID="rptEstadoPedido" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><%# Eval("IdEstadoPedido") %></td>
                            <td><%# Eval("Nombre") %></td>
