...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Estado Pedido" PostBackUrl="~/Admin/EstadoPedido/AgregarEstadoPedido.aspx"/>
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Estado Pedido" PostBackUrl="~/Admin/EstadoPedido/ModificarEstadoPedido.aspx"/>
        </div>
