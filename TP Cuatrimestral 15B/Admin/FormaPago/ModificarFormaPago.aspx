<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarFormaPago.aspx.cs" Async="true" Inherits="TP_Cuatrimestral_15B.Admin.FormaPago.ModificarFormaPago" %>
...
<body>
    ...
    <div class="formulario">
        ...
        <div class="fila">
            ...
            <asp:TextBox ID="txtDescripcion" Enabled="false" runat="server" CssClass ="form-control"></asp:TextBox>
        ...
        <div>
            <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" PostBackUrl="~/Admin/FormaPago/FormasPago.aspx" CssClass="btn btn-default" />
        </div>
