...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar forma de pago" PostBackUrl="~/Admin/FormaPago/AgregarFormaPago.aspx"/>
            <asp:Button ID="btnModificar" runat="server" Text="Modificar forma de pago" PostBackUrl="~/Admin/FormaPago/ModificarFormaPago.aspx"/>
        </div>
