<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormasPago.aspx.cs" Async="true" Inherits="TP_Cuatrimestral_15B.Admin.AdminFormasPago" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Admin - Formas de Pago</title>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar forma de pago" PostBackUrl="~/Admin/FormaPago/AgregarFormaPago.aspx" CssClass="btn btn-default" />
            <asp:Button ID="btnModificar" runat="server" Text="Modificar forma de pago" PostBackUrl="~/Admin/FormaPago/ModificarFormaPago.aspx" CssClass="btn btn-default" />
        </div>
        <table class="table table-striped table-hover tabla-admin">
            ...
            <tbody>
                <asp:Repeater ID="rptFormaPago" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><%# Eval("IdFormaPago") %></td>
                            <td><%# Eval("Nombre") %></td>
