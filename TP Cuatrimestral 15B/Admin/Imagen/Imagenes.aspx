<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Imagenes.aspx.cs" Async="true" Inherits="TP_Cuatrimestral_15B.Admin.WebForm4" %>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Imagen" PostBackUrl="~/Admin/Imagen/ModificarImagen.aspx" CssClass="btn btn-default" />
        </div>
