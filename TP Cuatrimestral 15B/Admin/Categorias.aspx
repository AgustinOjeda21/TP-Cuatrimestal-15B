<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="TP_Cuatrimestral_15B.Admin.AdminCategorias" %>
<!DOCTYPE html>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <table class="tabla-admin">
            ...
            <tbody id="tbodyCategorias" runat="server">
                <tr>
