...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            <asp:TextBox ID="txtBuscar" runat="server" placeholder="Buscar Estado Carrito..."></asp:TextBox>
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Estado Carrito" PostBackUrl="~/Admin/EstadoCarrito/AgregarEstadoCarrito.aspx"/>
            <asp:Button ID="btnModificar" runat="server" Text="+ Modificar Estado Carrito" PostBackUrl="~/Admin/EstadoCarrito/ModificarEstadoCarrito.aspx"/>
        </div>
