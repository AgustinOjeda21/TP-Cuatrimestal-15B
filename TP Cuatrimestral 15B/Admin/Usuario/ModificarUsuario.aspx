<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarUsuario.aspx.cs" Inherits="TP_Cuatrimestral_15B.Admin.Usuario.ModificarUsuario" %>
...
<body>
    <form id="form1" runat="server">
        <div class ="navbar"> Modificar Usuario
        </div>
        <div class="contenido">
    ...
    <div class="formulario">
        ...
        <div class="fila">
            <label>Rol</label>
            <asp:DropDownList ID="ddlRoles" runat="server" CssClass="form-control campo"> </asp:DropDownList>
