<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Async="true" Inherits="TP_Cuatrimestral_15B.Admin.WebForm8" %>
...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Usuario" PostBackUrl="~/Admin/Usuario/AgregarUsuario.aspx" CssClass="btn btn-default" />
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Usuario" PostBackUrl="~/Admin/Usuario/ModificarUsuario.aspx" CssClass="btn btn-default" />
        </div>
