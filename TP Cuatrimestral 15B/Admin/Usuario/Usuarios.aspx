...
<form id="form1" runat="server">
    ...
    <div class="contenido">
        ...
        <div class="acciones-top">
            ...
            <asp:Button ID="btnAgregar" runat="server" Text="+ Agregar Usuario" PostBackUrl="~/Admin/Usuario/AgregarUsuario.aspx"/>
            <asp:Button ID="btnModificar" runat="server" Text="Modificar Usuario" PostBackUrl="~/Admin/Usuario/ModificarUsuario.aspx"/>
        </div>
